...
$preparedSql = 'CREATE TABLE ' . $installer->getConnection()->quoteIdentifier($temporaryTableName) . ' ' . sprintf($sql,
    $orderAttributeTable,
...
$installer->getConnection()->query(
    'DROP TABLE ' . $installer->getConnection()->quoteIdentifier($temporaryTableName)
);
