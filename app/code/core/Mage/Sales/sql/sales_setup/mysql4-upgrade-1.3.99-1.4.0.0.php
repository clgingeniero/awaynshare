...
$installer->getConnection()->query('CREATE TABLE ' . $installer->getConnection()->quoteIdentifier($temporaryTable) . ' ' . $select->assemble());
...
$installer->getConnection()->query('DROP TABLE ' . $temporaryTable);
